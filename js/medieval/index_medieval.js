...
const jugador = new Jugador({
    ...
    imgSrc: '../img/assets-sprites/caballero1/Idle.png',
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : '../img/assets-sprites/caballero1/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : '../img/assets-sprites/caballero1/Jump.png',
            framesMax :  4
        } ,
        //al caer
        fall:{
            imgSrc : '../img/assets-sprites/caballero1/Fall.png',
            framesMax :  4
        } ,
        //al atacar
        attack1:{
            imgSrc : '../img/assets-sprites/caballero1/Attack.png',
            framesMax :  6
        },
        //al recibir daño
        takeHit:{
            imgSrc : '../img/assets-sprites/caballero1/Take Hit.png',
            framesMax :  4
        },
        //al morir
        death:{
            imgSrc : '../img/assets-sprites/caballero1/Death.png',
            framesMax :  9
        }
...
const enemigo = new Jugador({
    ...
    imgSrc: '../img/assets-sprites/caballero2/Idle.png',
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : '../img/assets-sprites/caballero2/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : '../img/assets-sprites/caballero2/Jump.png',
            framesMax :  3
        },
        //al caer
        fall:{
            imgSrc : '../img/assets-sprites/caballero2/Fall.png',
            framesMax :  3
        },
        //al atacar
        attack1:{
            imgSrc : '../img/assets-sprites/caballero2/Attack3.png',
            framesMax :  6
        },
        //al recibir daño
        takeHit:{
            imgSrc :'../img/assets-sprites/caballero2/GetHit.png',
            framesMax :  3
        },
        //cuando ninja muere
        death:{
            imgSrc : '../img/assets-sprites/caballero2/Death.png',
            framesMax :  14
        }
...
function animar(){
    ...
    if (teclas.ArrowLeft.pulsado && enemigo.ultimaTecla === "ArrowLeft" && enemigo.position.x > -120) {
        ...
        } else if (teclas.ArrowRight.pulsado && enemigo.ultimaTecla === "ArrowRight" && enemigo.position.x < (canvas.width - enemigo.width -130)) {
            enemigo.velocity.x = 5;
            enemigo.cambiarSprite("run");
        } else {
    ...
    if(
        rectanguloHitbox({
            ...
            rectangulo2: jugador})
             ...
             enemigo.ataca && enemigo.frameActual == 3 && tiempo > 0)
         {
            //recibimos golpe(animacion y daño)
            jugador.takeHit()
            //quitamos la propiedad de ataque
    ...
    //cancelamos la propiedad de ataque cuando se aplica el daño
    if(enemigo.ataca && enemigo.frameActual === 6){
        enemigo.ataca = false
    }
