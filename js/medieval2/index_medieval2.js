...
const jugador = new Jugador({
    ...
    imgSrc: './img/mago_guerrero/Idle.png',
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : './img/mago_guerrero/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : './img/mago_guerrero/Jump.png',
            framesMax :  3
        } ,
        //al caer
        fall:{
            imgSrc : './img/mago_guerrero/Fall.png',
            framesMax :  3
        } ,
        //al atacar
        attack1:{
            imgSrc : './img/mago_guerrero/Attack3.png',
            framesMax :  8
        },
        //al recibir daño
        takeHit:{
        ...
        //al morir
        death:{
            imgSrc : './img/mago_guerrero/Death.png',
            framesMax :  7
        }
...
const enemigo = new Jugador({
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : './img/mago/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : './img/mago/Jump.png',
            framesMax :  2
        },
        //al caer
        fall:{
            imgSrc : './img/mago/Fall.png',
            framesMax :  2
        },
        //al atacar
        attack1:{
            imgSrc : './img/mago/Attack1.png',
            framesMax :  8
        },
        //al recibir daño
        takeHit:{
