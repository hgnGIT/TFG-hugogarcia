...
const jugador = new Jugador({
    ...
    imgSrc: '../img/assets-sprites/samurai/Idle.png',
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : '../img/assets-sprites/samurai/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : '../img/assets-sprites/samurai/Jump.png',
            framesMax :  2
        } ,
        //al caer
        fall:{
            imgSrc : '../img/assets-sprites/samurai/Fall.png',
            framesMax :  2
        } ,
        //al atacar
        attack1:{
            imgSrc : '../img/assets-sprites/samurai/Attack1.png',
            framesMax :  6
        },
        //al recibir daño
        takeHit:{
            imgSrc : '../img/assets-sprites/samurai/Takehit.png',
            framesMax :  4
        },
        //al morir
        death:{
            imgSrc : '../img/assets-sprites/samurai/Death.png',
            framesMax :  6
        }
...
const enemigo = new Jugador({
    ...
    imgSrc: '../img/assets-sprites/ninja/Idle.png',
    ...
    sprites:{
        ...
        //al correr
        run:{
            imgSrc : '../img/assets-sprites/ninja/Run.png',
            framesMax :  8
        },
        //al saltar
        jump:{
            imgSrc : '../img/assets-sprites/ninja/Jump.png',
            framesMax :  2
        },
        //al caer
        fall:{
            imgSrc : '../img/assets-sprites/ninja/Fall.png',
            framesMax :  2
        },
        //al atacar
        attack1:{
            imgSrc : '../img/assets-sprites/ninja/Attack1.png',
            framesMax :  4
        },
        //al recibir daño
        takeHit:{
            imgSrc :'../img/assets-sprites/ninja/Takehit.png',
            framesMax :  3
        },
        //cuando ninja muere
        death:{
            imgSrc : '../img/assets-sprites/ninja/Death.png',
            framesMax :  7
        }
